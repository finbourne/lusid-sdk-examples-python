...
from lusid.extensions import ApiConfigurationLoader
...
api_factory = lusid.extensions.ApiClientFactory(
    token=lusid.extensions.RefreshingToken(config),
...
tx1 = models.TransactionRequest(
    ...
    instrument_identifiers={
        "Instrument/default/LusidInstrumentId": name_to_luid["VODAFONE GROUP PLC"]
    },
...
tx_portfolios_api.upsert_transactions(
